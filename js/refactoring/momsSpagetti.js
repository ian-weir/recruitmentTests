...
function momsSpagetti() {
    return new Promise((resolve, reject) => {
        ...
        combinedLyrics.push(lyrics.intro)

        lyrics.choruses.forEach(chorusObject => {
            combinedLyrics.push(chorusObject.chorus)
            combinedLyrics.push(lyrics.refrain.concat(' ').repeat(lyrics.refrainRepeat))
       })

       combinedLyrics.push(lyrics.ending)
       resolve(combinedLyrics.join(' '))
    })
};

momsSpagetti().then((successMessage) => console.log(successMessage))